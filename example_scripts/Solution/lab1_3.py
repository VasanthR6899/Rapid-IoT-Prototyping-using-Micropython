...
# Method  for coverting temperature from Fahrenheit to Celsius
   
def tempfToTempc(tempf):
    tempc = (tempf - 32) * 5//9
    return tempc
...
def main():
    ...
    #To Do Solution
    result = tempfToTempc(tempf)
    print("Temperature in Celsius is " + str(result) + "C")
